...
3. T-005/T-004: Optionally replace simulated municipal endpoints or synthetic municipal data with a safe real task system/public municipal dataset, but labels are now enforced in API and UI.
